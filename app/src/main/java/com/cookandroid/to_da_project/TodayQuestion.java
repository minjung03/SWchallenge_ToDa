...
public class TodayQuestion extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] Question = {"한달 후의 자신에게 하고 싶은 말은 무엇인가요 ?",
                "오늘 하루는 어땠나요 ?",
                "오늘 하루 중 돌아가고 싶은 순간은 언제인가요 ?",
                "오늘 가장 맛있게 먹었던 음식은 무엇인가요 ?",
                "주변 사람들에게 평소 하고 싶은 말이 있나요 ?",
                "오늘의 반성할 점은 무엇인가요 ?",
                "오늘 가장 보고 싶었던 사람은 누구였나요 ?",
                "오늘 하루를 한 문장으로 표현해주세요.",
                "오늘 하루 중 가장 기뻤던 순간은 언제인가요 ?",
                "오늘 하루를 어떤 식으로 마무리 하고 있으신가요 ?",
                "오늘의 목표는 무엇이였나요 ?",
                "오늘 가장 많이 느꼈던 감정은 무엇인가요 ?",
                "오늘 당신의 기분에 어울리는 색깔을 적어주세요. ",
                "이 다이어리를 열기 전 무엇을 하고 계셨나요 ?",
                "오늘의 자신에게 해줄 칭찬을 적어주세요 !",
                "다이어리를 닫은 뒤, 무엇을 하실껀가요 ?",
                "오늘의 제일 인상 깊었던 말은 무엇인가요 ?",
                "오늘, 당신을 가장 행복하게 만들었던 것은 무엇인가요 ?",
                "내일 죽는다면 당장 무엇을 하고싶나요 ?",
                "오늘은 어디를 다녀오셨나요 ?",
                "오늘 들었던 노래들 중 마음에 드는 게 있었나요 ?",
                "오늘 제일 하기 싫었던 일은 무엇인가요 ?",
                "당장 순간이동을 할 수 있다면 어디로 가고 싶나요 ?",
                "오늘 즐긴 여가 중 제일 재밌던 것은 무엇인가요 ?",
                "지금 가장 듣고 싶은 말은 무엇인가요 ?",
                "오늘 제일 보람찼던 일은 무엇인가요 ?",
                "오늘 아침 제일 먼저 한 일은 무엇인가요 ?",
                "어제의 당신보다 바뀐 점이 무엇인가요 ?",
                "오늘의 옷차림은 어떤가요 ?",
                "30일 간 질문에 답한 소감이 어떠신가요 ?"
        };
