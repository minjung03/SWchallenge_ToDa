...
public class TodayQuestionCrystal extends AppCompatActivity {
    ...
    String getDate, diary_value, user_id, DDB_userid, DDB_date, DDB_value, DDB_question, Toquestion;
        ...
        btnSumit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    String sql = "UPDATE diaryTBL SET diary = '" + diary_value + "' WHERE date = '"+ Toquestion +"';";
